...
1. **الشفاء الذاتي (Self-Healing)**
2.  للحاويات والخدمات الداخلية.
3. **تحمّل أحمال العمل (Workload Tolerance)**
4.  عبر تشغيل نسخ متعددة تلقائياً.
5. **النقل المؤقت (Temporary Migration)**
6.  أثناء الصيانة أو الأعطال لتقليل التوقف.
